-- Initial Migration: 001-initial
-- Creates all core tables for AI-WorkHub

-- This file is executed by the migration runner.
-- It is idempotent: tables use CREATE TABLE IF NOT EXISTS.
...
-- FTS5 virtual table for memory text search
